// src/pages/coordenador/CoordernadorLayout.jsx
import { Outlet, NavLink, useNavigate } from "react-router-dom";
import { motion, AnimatePresence } from "framer-motion";
import { LayoutDashboard, ShieldCheck, LogOut, Bell, ChevronDown, Menu, X } from "lucide-react";
...
export function CoordernadorLayout() {
  ...
  const [menuMobile, setMenuMobile] = useState(false); // Estado para o menu mobile
  ...
  // Extraímos o conteúdo da sidebar para reutilizar na versão Desktop e Mobile
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      {/* Main - Agora usa md:ml-55 para não aplicar margem no celular */}
